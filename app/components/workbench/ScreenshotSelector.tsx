    ...
    const handleCopySelection = useCallback(async () => {
      ...
      try {
        ...
        reader.onload = (e) => {
          ...
          if (textarea) {
            // Get the functions from the window object
            const setUploadedFiles = (window as any).__NEXUS_SET_UPLOADED_FILES__;
            const setImageDataList = (window as any).__NEXUS_SET_IMAGE_DATA_LIST__;
            const uploadedFiles = (window as any).__NEXUS_UPLOADED_FILES__ || [];
            const imageDataList = (window as any).__NEXUS_IMAGE_DATA_LIST__ || [];
